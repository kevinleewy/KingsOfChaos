...
import "./MilitaryLibrary.sol";

contract KingdomFactory4 {
    ...
    MilitaryLibrary.Military[] private militaries;
    Battle[] private battles;

    //MilitaryLibrary private mf;
    ...
    function KingdomFactory4() public {
    ...
    function _createKingdom(string _name, uint8 _race, uint8[4] _level, uint[5] _militaryCount, uint _commander)
      ...
      MilitaryLibrary._createMilitary(militaries, _militaryCount);
    ...
    function getPersonnel(uint _id) private view returns (uint256[7]) {
      return MilitaryLibrary.getMilitary(militaries, _id);
    ...
    function spyOnPersonnel(uint _targetId) public view returns (bool, uint256[7]) {
      ...
      if(senderId == _targetId || senderId == kingdoms[_targetId].commander){
        return (true, MilitaryLibrary.getMilitary(militaries, _targetId));
      }
      return MilitaryLibrary.spyOnMilitary(militaries, senderId, _targetId);
    }
    ...
    function getMyPersonnel() public view returns (uint256[7]) {
      ...
      return MilitaryLibrary.getMilitary(militaries, id);
    }
    ...
    function strikeAction(uint256 _id) public view returns (uint256) {
        var kingdom = kingdoms[_id];
        //var military = militaries[_id];
        return MilitaryLibrary.strikeAction(militaries, _id)
    ...
    function defensiveAction(uint256 _id) public view returns (uint256) {
        var kingdom = kingdoms[_id];
        //var military = militaries[_id];
        return MilitaryLibrary.defensiveAction(militaries, _id)
    ...
    function spyRating(uint256 _id) public view returns (uint256) {
      var kingdom = kingdoms[_id];
      //var military = militaries[_id];
      return MilitaryLibrary.spyRating(militaries, _id) * (100 + spyBonus[kingdom.race]) / 100
    ...
    function sentryRating(uint256 _id) public view returns (uint256) {
      var kingdom = kingdoms[_id];
      return MilitaryLibrary.sentryRating(militaries, _id) * (100 + sentryBonus[kingdom.race]) / 100
        * (uint256(100 + covertMultiplier) ** uint256(kingdom.covertLevel)) / (100 ** uint256(kingdom.covertLevel));
      //var military = militaries[_id];
    ...
    function recruit() public {
      ...
      MilitaryLibrary.recruit(militaries, id, numOfOfficers[id]);
    ...
    function trainAttackSpecialists(uint256 _count) public {
      ...
      MilitaryLibrary.trainAttackSpecialists(militaries, id, _count);
    ...
    function trainDefenseSpecialists(uint256 _count) public {
      ...
      MilitaryLibrary.trainDefenseSpecialists(militaries, id, _count);
    ...
    function trainSpies(uint256 _count) public {
      ...
      MilitaryLibrary.trainSpies(militaries, id, _count);
    ...
    function trainSentries(uint256 _count) public {
      ...
      MilitaryLibrary.trainSentries(militaries, id, _count);
    ...
    function reassignAttackSpecialists(uint256 _count) public {
      ...
      //military.numOfSoldiers += _count;
      //military.numOfAttackSpecialists -= _count;
      MilitaryLibrary.reassignAttackSpecialists(militaries, id, _count);
    ...
    function reassignDefenseSpecialists(uint256 _count) public {
      ...
      //military.numOfSoldiers += _count;
      //military.numOfDefenseSpecialists -= _count;
      MilitaryLibrary.reassignDefenseSpecialists(militaries, id, _count);
    ...
    function buyMercs(uint256 _attackMercsCount, uint256 _defenseMercsCount) public {
      ...
      MilitaryLibrary.buyMercs(militaries, id, _attackMercsCount, _defenseMercsCount);
